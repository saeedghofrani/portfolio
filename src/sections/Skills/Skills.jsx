  ...
  return (
    <section className={styles.skillsSection}>
      ...
      <div className={styles.skillCategory}>
        ...
        <p>
          Adept in Node.js (NestJS, TypeScript, Express), familiar with frontend
          frameworks (Angular), familiar with C# Language (ASP.NET Core).
        </p>
      </div>
      ...
      <div className={styles.skillCategory}>
        ...
        <p>
          ...
          proficient, MongoDB - proficient, Redis - proficient, RabbitMQ, Neo4j,
          MySQL, SQL, SQLite).
        </p>
      </div>
      ...
      <div className={styles.skillCategory}>
        <h3>Data Mastery</h3>
        <p>
          Skilled in ORMs (Prisma, TypeORM, Sequelize) and crafting complex raw
      ...
      <div className={styles.skillCategory}>
        ...
        <p>
          Implemented real-time functionalities using socket-based applications
          and Firebase for seamless data synchronization.
        </p>
      </div>
